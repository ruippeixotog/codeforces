namespace Solution {
  ...
  operation Test() : Unit {
    ...
    AssertOracleResult([true, false, false, true], true, Solve);
    AssertOracleResult([true, true, false, true, true, false], true, Solve);
    AssertOracleResult([true, true, false, false, true, false], false, Solve);
  }
}
